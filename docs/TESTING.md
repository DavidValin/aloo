...
| `features/` | Gherkin acceptance scenarios, one directory per story area (`channels/`, `connecting/`, `daemon/`, `diagnostics/`, `direct_punch/`, `encryption/`, `help/`, `identity/`, `messaging/`, `presence/`, `settings/`, `voice/`). |
